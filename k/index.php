...
<div class="container" style="height:100vh;display:flex;align-items: center;justify-content: center;">
  ...
  <form class="container" id="needs-validation" onsubmit="return false">
    <div class="add">
      ...
      <img src="https://i.ibb.co.com/xt10nnX8/file-000000005b747208a6fc8d3bbcf379fd.png" style="transform:scale(1.2);max-width: 100%">
      </div>
      ...
      <nav class="navbar navbar-light bg-dark text-white p-0 pl-2 rounded">
        ...
        <label class="mt-3" for="exampleInputEmail1">Nama Web Ressult</label>
      ...
      <label class="mt-3" for="exampleInputEmail1">List Email Kalian</label>
          <?php
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <label for="exampleInputEmail1">Nick Sender</label>
        ...
        <label class="mt-2" for="exampleInputEmail1">Email Sender</label>
...
<div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  ...
  <audio autoplay="" loop=""> 
   <source src="sad.mp3" type="audio/mpeg"> Your browser does not support the audio element. 
  </audio> 
